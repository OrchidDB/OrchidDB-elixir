...
try do
  ...
  Adbc.Connection.query!(connection, "INSERT INTO people VALUES (9007199254740993, 'Ada'), (2, NULL)")
  request = %{
  ...
  {:ok, _} = OrchidDB.query_arrow(connection, request, fn stream ->
  ...
  destination |> Adbc.Connection.query!("SELECT * FROM graph_result ORDER BY id") |> Adbc.Result.to_map() |> IO.inspect()
after
